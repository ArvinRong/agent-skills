#!/usr/bin/env python3
"""Build ready-to-copy dist layouts for supported agents."""
...
SKILL_NAME = "serena-lsp-companion"
CORE_SKILL = ROOT / "core" / SKILL_NAME
...
def build_codex() -> None:
    skill_dir = DIST / "codex" / ".agents" / "skills" / SKILL_NAME
...
def build_copilot() -> None:
    skill_dir = DIST / "copilot" / ".github" / "skills" / SKILL_NAME
    copy_core_runtime(skill_dir)
